/**
 * ITP Speech Testing Practice Module
 *
 * @author Ben Jordan
 */
...
function buttonClick(b)
{
    if(allowClick)
    {
        ...
        if(spokenWord === userWord)
        {
            ...
            document.getElementById("correctness").style.color = "#00ff00";
        }
        else
        {
            document.getElementById("correctness").innerHTML = "INCORRECT";
            document.getElementById("correctness").style.color = "#ff0000";
        }
    }
}

/**
 * Cleans up and continues to next trial (needed due to practice ui)
 */
...
/**
 * Colors the corrrect button or resets the button colors depending on the mode
 * @param mode 1 = color correct, 2 = reset colors
 */
function colorButtons(mode)
{
    if(mode === 1)
    {
        ...
        else if(spokenWord === b2 )
        {
            document.getElementById("c2").style.color = "#00ff00"
        }
        else if(spokenWord === b3)
        {
            document.getElementById("c3").style.color = "#00ff00";
        }
        else if(spokenWord === b4)
        {
            document.getElementById("c4").style.color = "#00ff00";
        }
    }
    else if(mode === 2)
    {
