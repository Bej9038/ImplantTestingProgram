...
$sql = "INSERT INTO SpeechTesting(TrialID, StartTime, EndTime, SNR, NumCorrect, I1, I2, 
...
I120)
VALUES ($trialid, '$starttime', '$endtime', '$snr', '$numc', '$arr[0]', '$arr[1]', '$arr[2]', '$arr[3]', '$arr[4]', '$arr[5]', 
